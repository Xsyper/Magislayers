--Super Dual HERO - Winged Warrior Avian
...
function s.setfilter(c)
	return (c:IsSetCard(0x46) or (c:IsSetCard(0x8) or (c:IsSetCard(0x03e7) and c:IsSpellTrap()))) and c:IsSSetable()
end
...
function s.setop(e,tp,eg,ep,ev,re,r,rp)
	...
	local c=e:GetHandler()
	--Cannot attack, except with "HERO" monsters
	local e1=Effect.CreateEffect(c)
