--Savior of the Magislayers - Jeanne D'Arc 
--Created and Scripted by Xsyper
local s,id=GetID()
function s.initial_effect(c)
	--xyz summon
	Xyz.AddProcedure(c,aux.FilterBoolFunctionEx(Card.IsSetCard,0x0309),8,3)
	c:EnableReviveLimit()
...
function s.spfilter1(c,e,tp)
	return c:IsSetCard(0x0309) and c:IsCanBeSpecialSummoned(e,0,tp,true,false) and not c:IsType(TYPE_XYZ)
